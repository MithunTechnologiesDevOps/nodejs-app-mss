...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Mithun Technologies. Please Contact +91-9980923226  +91-9900012028for more information or send an email to devopstrainingblr@gmail.com <center></h2>" );
    response.end();
